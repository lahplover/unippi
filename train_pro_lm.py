...
if gpu_mode == 2:
    ...
    # train_data_path = './data/multinode/seq_unalign_indel_all_cut_train_' + str(global_rank) + '.csv'
    train_data_path = './data/multinode/uniref50_train_shuffle_' + str(global_rank) + '_256-512.csv'
else:
    train_data_path = args.train_dataset
