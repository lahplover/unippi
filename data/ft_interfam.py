...
class DatasetFTInterFam(Dataset):
    ...
    def _get_item_two(self, item):
        if random.random() > 0.5:
            ...
            # print(is_next_label, self.seg_order_in_dm[item], self.seg_order_in_dm[item2],
            #       t1_dist_mat.shape, t2_dist_mat.shape, len(t1), len(t2))
...
if __name__ == '__main__':
    dataset = DatasetFTInterFam('data/pdb_interDM_unique_diff_domain_clean_sample.pkl', seq_len=600, relative_3d=False)
