...
class Transformer(nn.Module):
    def __init__(self, vocab_size, hidden=128, n_layers=1, attn_heads=8, dropout=0):
        ...
        self.decoder = Decoder(hidden, n_layers, attn_heads, dropout)
    ...
    def forward(self, x1, x2):
        ...
        memory, memory_mask = self.encoder(x1, mask1)
        ...
        x = self.decoder(x2, memory, memory_mask, mask_tgt)
...
class Decoder(nn.Module):
    ...
    def forward(self, x2, memory, memory_key_padding_mask, mask_tgt, tgt_key_padding_mask=None):
        x2 = x2.transpose(0, 1)
